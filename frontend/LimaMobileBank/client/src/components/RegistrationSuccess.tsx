...
export default function RegistrationSuccess({ onBack, onContinue }: RegistrationSuccessProps) {
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 p-6 max-w-md mx-auto w-full flex flex-col justify-center">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold mb-6">Вы успешно зарегистрировались</h2>
          <div className="space-y-3 text-left">
            <div className="flex items-center gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center">
                <Check className="h-4 w-4 text-primary" />
              </div>
              <span>1 Выбери цель</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center">
                <Check className="h-4 w-4 text-primary" />
              </div>
              <span>2 Подключи банк</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center">
                <Check className="h-4 w-4 text-primary" />
              </div>
              <span>3 Получай результат</span>
            </div>
          </div>
        </div>
      </div>
